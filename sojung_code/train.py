...
def train(
    ...
    model_path = os.path.join(log_dir, "pretrained_sq.pth")
    ...
    wandb.init(project="aistage_4", entity="sojung")
    wandb.save()
...
if __name__ == "__main__":
    ...
    if os.path.exists(log_dir): 
        modified = datetime.fromtimestamp(os.path.getmtime(log_dir + '/pretrained_sq.pth'))
